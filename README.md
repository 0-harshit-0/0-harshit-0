...
I'm a Full-Stack Engineer with 4+ years of experience creating and deploying software from scratch. views: <img src="https://raw.githubusercontent.com/0-harshit-0/0-harshit-0/refs/heads/main/assets/counter.svg" width="21" height="21" alt="git-together" />
...
- :package: Browser extensions, PIP/NPM libraries
- :diamond_shape_with_a_dot_inside: Web animation using Canvas API, SVGs, and ThreeJS
- :memo: Python applications using sockets, pillow, and other libraries
